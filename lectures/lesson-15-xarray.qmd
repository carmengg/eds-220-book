...
We will also learn how to subset data from these objects. 
...
The following is a concrete example of variables, dimensions, and attributes that guide the rest of the section. 
...
<!-- TO DO: insert image of variables, dims, coords -->
