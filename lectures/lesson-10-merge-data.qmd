...
Next, we want to select only the data for Scandinavian countries and a few of the 169 columns in the dataset:
...
Currently our datasets do not have any columns in column:
...
We can easily fix it by adding an `admin` column to `scandi_n_comms`. 
