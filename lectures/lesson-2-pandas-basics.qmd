...
Here's another example of using a condition. Suppose we want to look at data from years 1970 to 1979. One of doing this is to use the `in` operator in our condition:
...
```{python}
# select rows with 
# annual_sea_level_rise<0.5 mm OR annual_sea_level_rise>1 mm
