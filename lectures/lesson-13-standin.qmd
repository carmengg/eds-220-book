...
::: {.callout-warning}
# No outputs
There's some trouble with Quarto rendering this lesson which I'm working on fixing. 
All the code chunks are here, but none are executed. 
To see the output of the cells, check the notebook in our in-lesson repo:
[https://github.com/carmengg/eds-220-fall-2023-lessons/blob/main/week-5/lesson-13-clip-clean-2.ipynb](https://github.com/carmengg/eds-220-fall-2023-lessons/blob/main/week-5/lesson-13-clip-clean-2.ipynb)
:::
