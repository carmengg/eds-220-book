...
Another popular way of mixing strings and variables in print statements is using an **f-string** which stands for "formatted string". 
...
Rasters with high spatial resolution can 
