...
<!-- Solutions are commented at the end -->
...
`coral_div.Country.unique()` returns the uniqeu values of the `Country` column. These are the countries where the reefs are located:
