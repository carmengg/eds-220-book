...
5. When you run `git status` again, `data/` is not listed in untracked files. 
...
This shows both the head of our local directory and the head of our remote repository. 
